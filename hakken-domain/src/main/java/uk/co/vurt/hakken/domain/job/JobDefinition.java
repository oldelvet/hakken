...
public class JobDefinition implements Serializable{
	...
	public JobDefinition(Long id, String remoteId, String name, Long taskDefinitionId, Date created,
			Date due, String status, String notes, String description) {
		super();
		this.id = id;
	...
	public JobDefinition(Long id, String remoteId, String name, Long taskDefinitionId,
			Date created, Date due, String status, String group, String notes, String description,
			Set<DataItem> dataItems, boolean modified) {
        this(id, remoteId, name, taskDefinitionId, created, due, status, notes, description);
		this.created = created;
		this.due = due;
		this.status = status;
		this.group = group;
	...
	public JobDefinition(Long id, String remoteId, String name, Long taskDefinitionId,
			...
			String notes, String description, Set<DataItem> dataItems, boolean modified,
			String serverError) {
		this(id, remoteId, name, taskDefinitionId, created, due, status, group, notes, description, dataItems, modified);
		this.adhoc = adhoc;
