...
//		jobsProjectionMap.put(Job.Definitions.TASK_DEFINITION_NAME, Job.Definitions.TASK_DEFINITION_NAME);
		...
		jobsProjectionMap.put(Job.Definitions.DESCRIPTION, Job.Definitions.DESCRIPTION);
		...
		dataitemsProjectionMap.put(Dataitem.Definitions.SUBMIT, Dataitem.Definitions.SUBMIT);
	}
...
//				groupBy = Job.Definitions.GROUP;
	...
	private static class DatabaseHelper extends SQLiteOpenHelper {
		...
		public void onCreate(SQLiteDatabase db) {
			Log.w(TAG, "Creating SQLite database");
			...
			db.execSQL("CREATE TABLE IF NOT EXISTS " + JOBS_TABLE_NAME + " ("
					...
					+ Job.Definitions.DESCRIPTION + " TEXT, "
			...
			db.execSQL("CREATE TABLE IF NOT EXISTS " + DATAITEMS_TABLE_NAME + " ("
					...
					+ Dataitem.Definitions.SUBMIT + " TEXT, "
